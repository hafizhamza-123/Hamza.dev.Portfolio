							...
							<div className="row align-items-end py-60">
								...
								<div className="col-lg-6 mx-lg-auto col-md-12">
									<div className="p-lg-0 p-md-8 p-3">
										...
										<h1 className="fs-50 my-3">Junior <span className="text-linear-4">{'{'}Full Stack{'}'}</span>Web developer<span className="flicker">_</span></h1>
										...
										<Link href="/assets/imgs/resume/resume2.pdf" className="btn me-2 text-300 ps-0 mt-4" target="_blank">
