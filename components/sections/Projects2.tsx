														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															...
															<div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mt-7">
																<div className="d-flex flex-wrap align-items-center gap-3">
																	<Link href="https://hamza-dev-portfolio-delta.vercel.app/" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																	...
																	<Link href="https://github.com/hafizhamza-123/Hamza.dev.Portfolio" className="text-300 border-bottom border-1 px-2 pb-2 link-hover">
																...
																<div className="d-none d-lg-flex align-items-center gap-2 ms-lg-auto">
																	<button type="button" aria-label="Previous project" className="projects-swiper-prev shadow position-static m-0 border-0 d-inline-flex align-items-center justify-content-center" style={navButtonStyle} onClick={() => swiperInstance?.slidePrev()}>
																		<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
																			<path d="M7.82843 10.9999H20V12.9999H7.82843L13.1924 18.3638L11.7782 19.778L4 11.9999L11.7782 4.22168L13.1924 5.63589L7.82843 10.9999Z" fill="#1F1F24" />
																		</svg>
																	</button>
																	<button type="button" aria-label="Next project" className="projects-swiper-next shadow position-static m-0 border-0 d-inline-flex align-items-center justify-content-center" style={navButtonStyle} onClick={() => swiperInstance?.slideNext()}>
																		<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none">
																			<path d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z" fill="#1F1F24" />
																		</svg>
																	</button>
																</div>
															</div>
